VERSION 1.5 :
    ...
    - Nouveaux objets interne :
        * Mail => Permet d'envoyer des mails.
        * Webservices => Permet de se connecter à un webservice (Objet client d'un webservice, peut être exporté dans un autre projet).
