...
class                                               RequestManager
{
        ...
        {
                return self::execute($this->_requestCMD, $this->_requestsMethods, true);
        }
        ...
        */
        ...
        static public function                      execute($requestCMD, $requestsTypes = array(), $enableKeyAPI = false)
        {
                if (is_string($requestCMD) && !empty($requestCMD) && is_array($requestsTypes))
                {
                        ...
                        foreach ($requestsTypes as $requestsType)
                        {
                                ...
                                if ($request->getType() != false)
                                {
                                        ...
                                        if (($enableKeyAPI == false) || ($accessGetSecondRequest && $request->getType() == 'GET') || (\Webservices\Request::keyIsValid($request->getType(), $key)))
                                        {
