...
class                                                               Database
{
       ...
       */
        ...
        */
        ...
        {
                if (isset($this->_request) && !empty($this->_request))
                {
                        return $this->_request->errorInfo();
                }
                return false;
        }
        ...
        */
        public function                                         getAllQueryLine($fetch = \PDO::FETCH_ASSOC)
        {
                return ((isset($this->_request)) ? $this->_request->fetchAll($fetch) : false);
        }
